...
export const projects: Project[] = [
  {
    ...
    year: "2023",
    description:
      "Complete design and engineering delivery of an advanced S-lay pipelay system for a major offshore contractor. The project encompassed tensioner design, stinger optimisation, and full system integration for deep-water pipeline installation operations.",
    scope: [
  ...
  },
  {
    ...
    year: "2023",
    description:
      "Engineering and project delivery of a large-capacity cable carousel system for offshore wind inter-array cable installation. Delivered from concept design through to operational testing and deployment.",
    scope: [
      "FEED study and concept selection",
      "Detailed design engineering",
      "FEA and structural verification",
      "Factory acceptance testing",
      "Offshore commissioning support",
    ],
    image:
  ...
  },
  {
    ...
    scope: [
      "Concept development",
      "Innovative structural analysis methods",
  ...
  },
  {
    ...
    year: "2022",
    description:
      "Independent client representation and project management oversight for the fabrication and delivery of critical equipment packages for an FPSO project. Provided unbiased progress updates, quality assessments, and technical reviews.",
    scope: [
  ...
  },
  {
    ...
    year: "2021",
    description:
      "Design and engineering of a dedicated cable repair spread for submarine telecommunications cable maintenance operations. The system was optimised for rapid mobilisation and efficient repair operations.",
    scope: [
      "System concept and layout design",
      "Cable handling equipment design",
  ...
  },
  {
    ...
    year: "2021",
    description:
      "Comprehensive quality management system implementation and ISO 9001 certification support for a marine equipment manufacturer, including procedure development, staff training, and audit preparation.",
    scope: [
      "QMS gap analysis",
